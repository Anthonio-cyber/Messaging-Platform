...
const PATHS = {
  ...
  callEnd:
    'M22 9a16 16 0 0 0-20 0v3.5a1.5 1.5 0 0 0 1.5 1.5h3A1.5 1.5 0 0 0 8 12.5v-1.6a12 12 0 0 1 8 0v1.6a1.5 1.5 0 0 0 1.5 1.5h3A1.5 1.5 0 0 0 22 12.5Z',
  video: 'M23 7l-7 5 7 5V7ZM14 5H3a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Z',
  videoOff:
    'M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m4 0h5a2 2 0 0 1 2 2v3l4-3v9M1 1l22 22',
  micOff:
    'M15 9.34V4a3 3 0 0 0-5.94-.6M9 9v3a3 3 0 0 0 5.12 2.12M19 10v2a7 7 0 0 1-.11 1.23M12 19v4M8 23h8M1 1l22 22',
} as const;
